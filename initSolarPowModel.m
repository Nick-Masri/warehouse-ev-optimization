...
DN_solar_irr = readmatrix('DNIdata2020PA.xlsx','Sheet','DNIdata2020PA','Range','G4:G17523');% Read in Direct Normal Irradiance Data for all days in a year
DH_solar_irr = readmatrix('DNIdata2020PA.xlsx','Sheet','DNIdata2020PA','Range','F4:F17523');% Read in Diffuse Horizontal Irradiance Data for all days in a year
